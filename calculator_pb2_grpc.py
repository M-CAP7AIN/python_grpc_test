...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.IncRoot = channel.unary_unary(
                '/Calculator/IncRoot',
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'IncRoot': grpc.unary_unary_rpc_method_handler(
                    servicer.IncRoot,
...
class Calculator(object):
    ...
    def IncRoot(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator/IncRoot',
...
class Calculator2Stub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.DecRoot = channel.unary_unary(
                '/Calculator2/DecRoot',
                request_serializer=calculator__pb2.Number.SerializeToString,
                response_deserializer=calculator__pb2.Number.FromString,
                )
...
class Calculator2Servicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_Calculator2Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            'DecRoot': grpc.unary_unary_rpc_method_handler(
                    servicer.DecRoot,
                    request_deserializer=calculator__pb2.Number.FromString,
                    response_serializer=calculator__pb2.Number.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Calculator2', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class Calculator2(object):
    ...
    def DecRoot(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator2/DecRoot',
            calculator__pb2.Number.SerializeToString,
            calculator__pb2.Number.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
